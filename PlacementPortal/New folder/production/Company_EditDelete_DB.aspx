<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Company_EditDelete_DB.aspx.cs" Inherits="New_folder_production_Company_EditDelete_DB" %>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Placement Portal!</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Company <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="Company_EditDelete_DB.aspx">Edit/Delete</a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Graphs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    <li><a href="Graph1.aspx">Moris JS</a></li>
                    <li><a href="Graph2.aspx">ECharts</a></li>
                    <li><a href="Graph3.aspx">Other Charts</a></li>
